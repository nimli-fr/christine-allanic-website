...
const navigation = [
  ...
  { name: "Formation SST", href: "/formation-sst" },
      ...
      <nav className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <Link href="/" className="flex items-center gap-2">
            ...
            <div className="leading-tight">
              <span className="font-bold text-accent text-lg">Formations</span>
        ...
        {mobileOpen && (
          <div className="md:hidden pb-4 border-t border-gray-100">
            ...
            <Link
              href="/contact"
              className="block mt-2 bg-primary text-white px-4 py-2 rounded-lg text-sm font-semibold text-center hover:bg-primary-dark transition-colors"
              onClick={() => setMobileOpen(false)}
            >
              Me contacter
            </Link>
