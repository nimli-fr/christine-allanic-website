...
export const metadata: Metadata = {
  ...
  description:
    "R\u00e9alisez votre bilan de comp\u00e9tences avec Christine Allanic. Accompagnement personnalis\u00e9, certifi\u00e9 Qualiopi, \u00e9ligible CPF.",
};
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-foreground/70 leading-relaxed">
            Il se d&eacute;roule en <strong>3 phases</strong> sur une dur&eacute;e de <strong>24 heures</strong> r&eacute;parties
            sur <strong>12 semaines</strong> maximum.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            {[
              ...
              <div key={phase.step} className="flex gap-6 items-start bg-white rounded-xl p-6 shadow-sm">
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {[
              { label: "Dur\u00e9e", value: "24 heures sur 12 semaines max" },
              { label: "Modalit\u00e9s", value: "Pr\u00e9sentiel ou distanciel (visio)" },
              { label: "Financement", value: "CPF, plan de d\u00e9veloppement des comp\u00e9tences, autofinancement" },
      ...
      <section className="py-16 watercolor-bg">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-foreground/60 mb-8">
            B&eacute;n&eacute;ficiez d&rsquo;un entretien pr&eacute;alable gratuit et sans engagement pour &eacute;changer sur vos besoins.
          </p>
          <Link
            href="/contact"
